...
$check= mysql_fetch_array(mysql_query("SELECT COUNT(*) FROM user_details WHERE username='".$username."'"));
...
$res = mysql_query("INSERT INTO users SET username='".$username."', password='".$passmd."', email='".$email."', mobile='".$mobile."', name='".$name."'");
