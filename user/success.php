...
<div class="container">
<div class="spacer">
<center><h3>Confirm Your Ticket Through Transection Code</h3></center><hr>
...
$res = mysql_query("UPDATE seat_details SET uid='".$uid."',  pname='".$pname."', pmobile='".$pmobile."', start='".$splace."', depart='".$dplace."', status='2' WHERE busid='".$bid."' AND seatid='".$seats."'");
if($res){
...
$ticket = mysql_query("INSERT INTO ticket_details SET busid='".$bid."', uid='".$uid."', pname='".$pname."', pmobile='".$pmobile."', start='".$splace."', depart='".$dplace."', seats='".$ssee."', cost='".$total."', status='2'");
...
$tkt = mysql_fetch_array(mysql_query("SELECT id FROM ticket_details ORDER BY id DESC"));
