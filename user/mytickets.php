...
$ddaa = mysql_query("SELECT id, busid, seats, cost FROM ticket_details WHERE uid='".$uid."'");
    echo mysql_error();
    while ($data = mysql_fetch_array($ddaa))
    {
$buss = mysql_fetch_array(mysql_query("SELECT id, route, time, date FROM bus_info WHERE id='".$data[1]."'"));

$rname = mysql_fetch_array(mysql_query("SELECT routename FROM bus_route WHERE id='".$buss[1]."'"));
