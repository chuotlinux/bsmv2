...
$res = mysql_query("UPDATE seat_details SET  pname='".$pname."', pmobile='".$pmobile."', start='".$splace."', depart='".$dplace."', status='1' WHERE busid='".$bid."' AND seatid='".$seats."'");
if($res){
...
$ticket = mysql_query("INSERT INTO ticket_details SET busid='".$bid."', pname='".$pname."', pmobile='".$pmobile."', start='".$splace."', depart='".$dplace."', seats='".$ssee."'");
if($ticket){
