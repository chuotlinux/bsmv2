...
mysql_query("UPDATE seat_details SET uid='', pname='', pmobile='', start='', depart='', trxid='', status='0', note='' WHERE id='".$seatid."'");
...
mysql_query("UPDATE seat_details SET status='1' WHERE id='".$seatid."'");
...
if($seatid==1){
	...
	mysql_query("UPDATE ticket_details SET status='1' WHERE busid='".$busid."' AND seats LIKE '".$seat."%'");
...
$ddaa = mysql_query("SELECT id, busid, seatid, pmobile, trxid FROM seat_details WHERE status='2'");
    echo mysql_error();
    while ($data = mysql_fetch_array($ddaa))
    {

$rname = mysql_fetch_array(mysql_query("SELECT routename FROM bus_route WHERE id='".$data[1]."'"));
$bss = mysql_fetch_array(mysql_query("SELECT date, time FROM bus_info WHERE id='".$data[1]."'"));
